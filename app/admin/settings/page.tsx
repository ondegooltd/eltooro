          ...
          <div className="container mx-auto px-4 py-8">
            ...
            <Tabs defaultValue="general" className="space-y-6">
              ...
              <TabsContent value="delivery">
                <Card>
                  <CardHeader>
                    <CardTitle>Delivery Cities &amp; Fees</CardTitle>
                    <CardDescription>
                      Add, edit, or remove the cities customers can choose at
                      checkout. Changes take effect after you click “Save
                      Changes”.
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        <Label htmlFor="otherFee">
                          Other / Unlisted City Fee (GH₵)
                        </Label>
                        <p className="text-sm text-muted-foreground mb-1">
                          Charged when a customer picks “Other” at checkout.
                        </p>
                        <Input
                          id="otherFee"
                          type="number"
                          min={0}
                          value={settings.deliveryFees.other}
                          onChange={(e) =>
                            setSettings({
                              ...settings,
                              deliveryFees: {
                      ...
                      <div>
                        <Label htmlFor="internationalFee">
                          International Fee (GH₵)
                        </Label>
                        <p className="text-sm text-muted-foreground mb-1">
                          Applied to international (USD) orders.
                        </p>
                        <Input
                          id="internationalFee"
                          type="number"
                          min={0}
                          value={settings.deliveryFees.international}
                          onChange={(e) =>
                            setSettings({
                              ...settings,
                              deliveryFees: {
                        ...
                        <Table>
                          <TableHeader>
                            <TableRow>
                              ...
                              <TableHead className="w-40">Fee (GH₵)</TableHead>
                          ...
                          <TableBody>
                            {settings.deliveryFees.cities.length === 0 ? (
                              <TableRow>
                                <TableCell
                                  colSpan={3}
                              ...
                              settings.deliveryFees.cities.map((city, index) => (
                                <TableRow key={index}>
                                  <TableCell>
                                    <Input
                                      placeholder="City name (e.g. Accra)"
                                      value={city.name}
                                      onChange={(e) => {
                                        const cities = [
                                          ...settings.deliveryFees.cities,
                                        ];
                                        cities[index] = {
                                          ...cities[index],
                                          name: e.target.value,
                                  ...
                                  <TableCell className="text-right">
                                    <Button
                                      ...
                                      onClick={() => {
                                        const cities =
                                          settings.deliveryFees.cities.filter(
                                            (_, i) => i !== index
                                          );
                                        setSettings({
                                          ...settings,
