...
export default function AdminShippingMethodsPage() {
  ...
  const deleteShippingMethod = async (methodId: string, methodName: string) => {
    if (
      !confirm(
      ...
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-1 bg-muted">
          <div className="container mx-auto px-4 py-8">
            <div className="mb-8 flex justify-between items-center">
              <div>
                ...
                <p className="text-muted-foreground mt-1">
                  Manage delivery methods and delivery options
                </p>
              </div>
            ...
            <Card className="mb-6">
              <CardHeader>
                <CardTitle>Search Delivery Methods</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  {filteredMethods.length} delivery method
