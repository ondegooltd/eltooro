  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(
          error.error?.message || "Failed to create delivery method",
        );
      }
        ...
        <main className="flex-1 bg-muted">
          <div className="container mx-auto px-4 py-8">
            <div className="mb-6">
              ...
              <h1 className="text-3xl font-bold">Create New Delivery Method</h1>
            </div>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mt-6 flex justify-end gap-4">
                ...
                <Button type="submit" disabled={isLoading}>
                  ...
                  {isLoading ? "Creating..." : "Create Delivery Method"}
                </Button>
              </div>
            </form>
          </div>
