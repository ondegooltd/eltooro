          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto space-y-8">
                ...
                <div className="space-y-4">
                  <div className="border-l-4 border-iherb-green pl-4">
                    ...
                    <p className="text-muted-foreground">
                      ...
                      arrange shipping, provide order confirmations, and handle
                      returns or refunds. This includes sharing necessary
                      information with shipping partners and payment processors
                  ...
                  <div className="border-l-4 border-iherb-green pl-4">
                    ...
                    <p className="text-muted-foreground">
                      ...
                      support needs. We may also contact you about your account
                      or transactions to ensure security and prevent fraud.
                    </p>
                  </div>
                  <div className="border-l-4 border-iherb-green pl-4">
                    <h3 className="font-semibold mb-2">
                    ...
                    <p className="text-muted-foreground">
                      ...
                      performance to enhance user experience, optimize our
                      platform, develop new features, and improve product
                      recommendations. This helps us provide you with a better
                      shopping experience.
                    </p>
                  </div>
                  <div className="border-l-4 border-iherb-green pl-4">
                    ...
                    <p className="text-muted-foreground">
                      ...
                      product updates. You can opt-out of these communications
                      at any time through your account settings or by clicking
                  ...
                  <div className="border-l-4 border-iherb-green pl-4">
                    ...
                    <p className="text-muted-foreground">
                      ...
                      obligations, enforce our terms of service, protect our
                      rights and security, prevent fraud, and respond to legal
              ...
              <div>
                ...
                <div className="bg-muted/50 rounded-lg p-6 space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      We comply with the Ghana Data Protection Act, 2012 (Act
                      843) and applicable international data protection laws,
                      including GDPR for European customers. We are committed to
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      ...
                      conducting our business, or serving our customers, and
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      ...
                      enforce our agreements. When data is no longer needed, we
              ...
              <div>
                ...
                <div className="space-y-4">
                  <p className="text-muted-foreground">
                    Under applicable data protection laws, including the Ghana
                    Data Protection Act, 2012 (Act 843), you have the following
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div className="border rounded-lg p-4">
                      ...
                      <p className="text-sm text-muted-foreground">
                        You may request a copy of the personal information we
                        hold about you.
                      </p>
                    </div>
                    <div className="border rounded-lg p-4">
                    ...
                    <div className="border rounded-lg p-4">
                      ...
                      <p className="text-sm text-muted-foreground">
                        You may withdraw consent for processing where consent is
                        the legal basis.
                      </p>
                    </div>
                  </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground mb-4">
                  ...
                  your browsing experience, analyze website traffic, personalize
                  content, and remember your preferences. Cookies are small text
              ...
              <div>
                ...
                <p className="text-muted-foreground mb-4">
                  ...
                  analyze information to help us operate and improve our
                  platform. These services include:
                </p>
                <ul className="list-disc list-inside space-y-1 text-muted-foreground ml-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  ...
                  countries other than your own, including countries outside
                  Ghana. We ensure appropriate safeguards are in place for such
                  transfers, including standard contractual clauses and
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  ...
                  posting the updated policy on this page and updating the
