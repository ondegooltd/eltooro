...
/**
 * GET /api/admin/shipping-methods - Get all shipping methods (admin)
 */
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    logger.error("Admin shipping methods list failed", error as Error, {
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    logger.error("Shipping method creation failed", error as Error, {
      endpoint: "/api/admin/shipping-methods",
    });
    logRequest(
      "POST",
