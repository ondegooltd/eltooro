    ...
    if (faqs.length === 0) {
      faqs = [
        ...
        },
        {
          ...
          answer:
            "Shipping times vary by destination and shipping method. For Ghana, standard delivery typically takes 3-7 business days. International shipping may take 7-21 business days depending on the destination. Check our Shipping page for specific estimates to your location.",
          category: "shipping",
        },
        {
