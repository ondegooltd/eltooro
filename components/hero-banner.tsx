...
const banners = [
  {
    id: 1,
    title: "SUPPLEMENTS 20% OFF",
    subtitle: "Stock up on your favorites",
    image: "/vitamins-supplements-green-banner-sale.jpg",
  ...
  },
  {
    id: 2,
    title: "Try it First",
    subtitle: "Save 50% or More",
    image: "/trial-size-products-health-beauty.jpg",
    link: "/products?q=trial",
    bgColor: "bg-teal-600",
  },
  {
    id: 3,
    ...
    image: "/wellness-healthy-lifestyle-products.jpg",
  ...
  },
  {
    id: 4,
    title: "20% Off Tea",
    subtitle: "Organic & Herbal Blends",
    image: "/organic-herbal-tea-collection.jpg",
    link: "/products?q=tea",
              ...
              <div className="absolute inset-0 flex items-center">
                <div className="container mx-auto px-4">
                  <div className="max-w-lg text-white">
                    <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold mb-2 text-balance">{banner.title}</h2>
                    <p className="text-lg sm:text-xl md:text-2xl opacity-90">{banner.subtitle}</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              >
                <div className="aspect-[3/1] relative">
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center text-white text-center p-2">
                    <span className="text-xs sm:text-sm font-bold">{banner.title}</span>
                    <span className="text-xs opacity-90 hidden sm:block">{banner.subtitle}</span>
                  </div>
                </div>
              </Link>
            ))}
